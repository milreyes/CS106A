...
public class Breakout extends GraphicsProgram {
	...
	private void controlBall(){
		...
		/*This if statement checks if the ball hits on the first half of the paddle.
		 * */
		...
		/*This if statement checks if the ball second on the last half of the paddle.
		 * */
	...
	private static final double PADDLE_CONTROL_ZONE = 0.5 ; // Area of the paddle that will change ballVx speed.
}
